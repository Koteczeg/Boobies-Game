...
namespace BoobiesGame3
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            gameElements.Initialize(Content, GraphicsDevice);
            ...
            graphics.PreferredBackBufferWidth = (int)gameElements.Resolution.X;
            graphics.PreferredBackBufferHeight = (int)gameElements.Resolution.Y;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (gameElements.newGame)
                this.Initialize();
            if (Keyboard.GetState().IsKeyDown(Keys.Escape))
                this.Exit();
            gameElements.Update(gameTime,this.Window,Content,GraphicsDevice);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            gameElements.Draw(gameTime, spriteBatch,this.Window, Content);
            spriteBatch.End();
